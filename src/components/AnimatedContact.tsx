    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-red-50">
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 md:px-8">
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-[#0F47AF]">¡Contáctanos!</h1>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              <a href="https://maps.google.com/?q=3318+Bourbon+St,+Fredericksburg,+VA" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-800 hover:text-[#E41F1D] transition-colors text-sm sm:text-base">
                <FaMapMarkerAlt className="w-5 h-5 mr-3" />
                3318 Bourbon St, Fredericksburg, VA
              </a>
              <a href="tel:+15404791687" className="flex items-center text-gray-800 hover:text-[#E41F1D] transition-colors text-sm sm:text-base">
                <FaPhone className="w-5 h-5 mr-3" />
                (540) 479-1687
              </a>
              <a href="mailto:Hskva2017@gmail.com" className="flex items-center text-gray-800 hover:text-[#E41F1D] transition-colors text-sm sm:text-base">
            ...
            >
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <a
                    ...
                    className="flex flex-col items-center justify-center p-3 sm:p-4 bg-gradient-to-br from-red-100 to-red-50 rounded-lg hover:from-red-200 hover:to-red-100 transition-colors"
                  >
                    <FaInstagram className="w-6 h-6 sm:w-8 sm:h-8 text-red-600 mb-2" />
                  ...
                  <a
                    ...
                    className="flex flex-col items-center justify-center p-3 sm:p-4 bg-gradient-to-br from-red-100 to-red-50 rounded-lg hover:from-red-200 hover:to-red-100 transition-colors"
                  >
                    <FaFacebookF className="w-6 h-6 sm:w-8 sm:h-8 text-red-600 mb-2" />
              ...
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 bg-[#E41F1D] text-white font-semibold rounded-md hover:bg-red-700 transition-colors text-sm sm:text-base w-full sm:w-auto"
                >
