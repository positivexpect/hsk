    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-red-50">
      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-6">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#0F47AF]">¡Eventos Especiales!</h1>
          ...
          >
            ...
            <div className="p-8">
              <h2 className="text-2xl font-bold mb-4 text-[#0F47AF]">Private Chef Experience</h2>
        ...
        >
          <div className="bg-gray-50 rounded-lg p-8">
            <h2 className="text-3xl font-bold mb-8 text-center text-[#0F47AF]">Upcoming Events</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold mb-2 text-[#0F47AF]">Food Truck Friday</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold mb-2 text-[#0F47AF]">Farmers Market</h3>
                <p className="text-gray-800 mb-4">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <h3 className="text-xl font-semibold mb-2 text-[#0F47AF]">Sunday Brunch</h3>
                <p className="text-gray-800 mb-4">
